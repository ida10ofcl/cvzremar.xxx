sunflower=function(x,y){
	...
	this.image.src="https://cvzimgv.netlify.app/SunflowerHD.png";
};
sunflower.prototype={
	cost:25,
	draw:function(){
...
peashooter=function(x,y){
	...
	snumb-=this.cost;
	this.image = new Image();
	this.image.src="https://cvzimgv.netlify.app/PeashooterHD.png";
};
...
walker=function(x,y){
	...
	this.attack=1;
	this.image = new Image();
	this.image.src="https://cvzimgv.netlify.app/ZombieHD.png";
};
walker.prototype={
	draw:function(){
		context.drawImage(this.image,this.x,this.y,gamefield.playgroundWidth,gamefield.playgroundHeight);
...
Sun=function(x,y,sunS){
	...
	this.image = new Image();
	this.image.src="https://cvzimgv.netlify.app/SunHD.png";
	this.rotation=0;
};
Sun.prototype={
	draw:function(){
...
wallnut=function(x,y){
	...
	snumb-=this.cost;
	this.image = new Image();
	this.image.src="https://cvzimgv.netlify.app/WallnutHD.png";
};
wallnut.prototype={
	cost:100,
	draw:function(){
